...
Конечно! Приглашайте друзей и получайте вознаграждение: 20 бесплатных генераций за каждого друга, оплатившего подписку.  Создайте свою реферальную ссылку в личном кабинете после оплаты.
